...
if __name__ == "__main__":
    TRAIN_DIR = "D:/tools/Pycode/CapsnetForAD/data/ToyCar/train"
    TEST_DIR = "D:/tools/Pycode/CapsnetForAD/data/ToyCar/test"
    RESULT_PATH = "D:/tools/Pycode/CapsnetForAD/workresult"
    extract_antishift_features(TRAIN_DIR, os.path.join(RESULT_PATH, "train_car_mon.h5"))
    extract_antishift_features(TEST_DIR, os.path.join(RESULT_PATH, "test_car_mon.h5"))